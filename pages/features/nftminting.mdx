...
<Callout emoji="⚠️"> It is very important to make sure all these details are correct before the actual minting as the process can not be undone. The “Delete” action can be used for emergencies but will simply unlist the NFT from OpenZoo.
