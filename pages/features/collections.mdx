...
In Openzoo, you can navigate through all existing users collections created. Each collection card displays all details selected by the creator including the type of collection (WRC-721 or WRC-1155), the categories, the number of NFTs minted and the number of owners.
