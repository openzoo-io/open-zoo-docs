...
Before you start, make sure you have downloaded Metamask and connected it to the Wanchain network. For more info on how to proceed, check the following guide: [Connect Metamask](https://www.youtube.com/watch?v=t8Od0j0ta2A)
