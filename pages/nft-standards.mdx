...
This can largely reduce the amount of data required to distinguish one token from another and ultimately result in reducing the network congestion and largely reduce the gas fees.
While WRC-721 allows tokenized assets to be transferred from wallet to wallet, this process is slow and has to be done one at a time.
WRC-1155 seeks to address this issue, allowing collections of NFTs to fall under a single, smart contract.
